...
static uint8_t DeeployNetwork_TILING_CODEGEN_L1_Add_numTiles[2] = {0, 1};
...
void InitNetwork() {
  ...
  DeeployNetwork_MEMORYARENA_L1 = (int8_t *)pi_l1_malloc(0, sizeof(int8_t) * 750);

  DeeployNetwork_MEMORYARENA_L2 = (int8_t *)pi_l2_malloc(sizeof(int8_t) * 1500);

  DeeployNetwork_input_0 = (int8_t *)((char *)DeeployNetwork_MEMORYARENA_L2 + 500);
  DeeployNetwork_input_1 = (int8_t *)((char *)DeeployNetwork_MEMORYARENA_L2 + 1000);
